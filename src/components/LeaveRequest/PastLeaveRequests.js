        ...
        <>
            <div className="d-flex combine-past-applied">
                ...
                <div className="past-leave-requests mr-4 ml-4 mt-4">
                    ...
                    <hr style={{ width: "90%", marginTop: "1.0rem", borderTop: ".1rem solid rgb(239 244 247, 0.3)" }} />
                    {/* .......................Details heading.............................. */}
                    <div className="d-flex leave-request-left-card-heading justify-content-between col-11 mb-4">
                        ...
                        <p className="pt-2 pr-2 pb-2">Date applied on</p>
                        <p className="pt-2 pr-4 pb-2">Action</p>
                    </div>

                    {/* .......................Data Parsed.............................. */}
                    {pastLeaveRequestsData.map((data, index) => (
                        <div key={index} className="d-flex ml-5 leave-request-left-data justify-content-between mt-4">
                            ...
                            <p className="pl-5">{(data.startDate.split(" ")[0]).replaceAll("-", ", ")}</p>
                            <div className="d-flex">
                                <p className="mr-4">{data.status}</p>
                                <i className="far fa-eye mr-4 pt-2 pr-2" onClick={() => { setclickEyeIcon(true); setindexForEye(index) }}></i>
                            </div>
